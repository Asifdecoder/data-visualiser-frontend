...
const CountryChart = () => {
  ...
  return (
    <Box overflow="hidden" p={6} shadow="md" bg={useColorModeValue("white", "gray.800")} m={50}>
      <Flex direction="column" margin={'auto'}>
        <Heading marginLeft='90px' as={"h2"} textAlign="left" mb={4} style={{ textAlign: "left" }} >
          Country Chart
        </Heading>
        <Select marginLeft='90px'
        ...
        <Box marginLeft='90px'  height="500px" width={"100%"}>
